...
class GeneratorInformationResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'internal_cage'           => (bool) $this->internal_cage,
            'external_capacity'       => $this->external_capacity,
            'external_existing_fuel'  => $this->external_existing_fuel,
            'external_cage'           => (bool) $this->external_cage,
            'fuel_sensor_exiting'     => (bool) $this->fuel_sensor_exiting,
            'fuel_sensor_working'     => (bool) $this->fuel_sensor_working,
