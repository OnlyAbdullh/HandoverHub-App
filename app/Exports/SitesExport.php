    ...
    public function collection(): Collection
    {
        ...
        foreach ($this->sites as $site) {
            ...
            for ($i = 0; $i < $this->maxBands; $i++) {
                ...
                $rowData["band_type_" . ($i + 1)]     = $band ? $band->band_type : '';
                $rowData["band_rbs_1_type_" . ($i + 1)]  = $band ? $band->rbs_1_type : '';
                $rowData["band_rbs_2_type_" . ($i + 1)]  = $band ? $band->rbs_2_type : '';
                $rowData["band_du_1_type_" . ($i + 1)]   = $band ? $band->du_1_type : '';
                $rowData["band_du_2_type_" . ($i + 1)]   = $band ? $band->du_2_type : '';
                $rowData["band_ru_1_type_" . ($i + 1)]   = $band ? $band->ru_1_type : '';
                $rowData["band_ru_2_type_" . ($i + 1)]   = $band ? $band->ru_2_type : '';
                $rowData["band_remarks_" . ($i + 1)]     = $band ? $band->remarks : '';
            }
